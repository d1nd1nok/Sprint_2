...
case = ExtendedCase(1, "Проверка авторизации", "Ввести правильные логин и пароль", "Пользователь успешно авторизован", "Пользователь зарегистрирован", "Windows 10, Chrome")
